...
namespace WCS
{
    public class Startup
    {
        ...
        {
            //services.AddDbContext<WcsContext>(options => options.UseSqlServer("Server = (localdb)\\mssqllocaldb; Database = wcs; Trusted_Connection = True; MultipleActiveResultSets = true"));
            ...
            // Configure Password and User SettingsFa
            ...
            services.AddDbContext<WcsContext>(o => o.UseSqlServer(Configuration.GetConnectionString("wcs")));
