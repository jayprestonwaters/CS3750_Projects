...
namespace WCS.Controllers
{
    ...
    public class StudentController : Microsoft.AspNetCore.Mvc.Controller
    {
        ...
        public async Task<IActionResult> CreateStudentProfile([Bind("Prefix,BirthDate,Address,Address2,City,State,ZipCode,Gender," +
            ...
            "LastUniversity,FirstWsuSemester,FirstWsuYear,CurrentScheduleStatus,ApTestList,ClubAndOrganizationHistory,HighSchoolStem, AwardsHistory," +
        ...
        public async Task<IActionResult> EditStudentProfile([Bind("Id,Prefix,BirthDate,Address,Address2,City,State,ZipCode,Gender," +
            "MaritalStatus,OverallGPA,MajorGPA,ActScore,CurrentMajor,FutureMajor,CurrentAcademicLevel,UltimateDegreeGoal,HighSchool," +
            "LastUniversity,FirstWsuSemester,FirstWsuYear,CurrentScheduleStatus,ApTestList,ClubAndOrganizationHistory,HighSchoolStem," +
            "AwardsHistory,CsInterest,ScholarshipAidHistory,AchievementsHistory, StudentCourses, WNumber")] StudentProfile profile)
        {
            if (ModelState.IsValid)
            {
                //Grab the user
