...
<nav class="navbar navbar-dark bg-dark">
  ...
  <form action="action.php" method="post">
    <div class="container card bg-dark mt-3 text-center" style="width: 30rem">
      <h2 class="card-header text-uppercase fw-bold">Sign Up</h2>
      <div class="card card-body bg-secondary my-2 d-flex align-items-center">
        ...
        <div class="form-floating">
          <input autocomplete="new-password" class="form-control" required id="id_password" type="password" name="password" placeholder="Password" style="width: 15rem">
          <label for="id_password">Password</label>
        </div>
        <div class="col">
          <button class="btn btn-outline-info btn-lg fw-bold mt-4" type="submit">Sign Up</button>
        </div>
      </div>
    </div>
